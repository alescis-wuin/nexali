...
grep -Fq '<EnforceCodeStyleInBuild>false</EnforceCodeStyleInBuild>' "$repo_root/Directory.Build.props" || die "Phase 1.6 code-style boundary missing."
log OK "Repository-wide build properties are valid."
